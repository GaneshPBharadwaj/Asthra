...
const MainGrid = () => {
  return (
    <Box sx={{width:'1353px', height:'1043px', left:'0px', top:'0px',position:'absolute', }}>
      <Box sx={{backgroundColor: '#f5f5f5', width:'1352px', height:'1043px',left:'145px', position:'absolute'}}>
          <Navbar/>
      </Box>
      ...
      <Box sx={{width:'922px', height:'406px', top:'575px', left:'177px', position:'absolute'}}>
        <AnalyticGraph/>
      </Box>
    </Box>
  )
